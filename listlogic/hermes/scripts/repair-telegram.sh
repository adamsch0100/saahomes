...
echo ""
echo "If RAILWAY_SERVICE_ID points at THIS Hermes service, site deploys will restart the gateway."
echo "It must be the listlogic.homes WEBSITE service ID, not Hermes."
