  ...
  return (
    <section id="home" className="relative w-full min-h-screen flex flex-col bg-black">
      ...
      <video
        ...
        muted
        playsInline
        poster="https://assets.thesparksite.com/uploads/sites/4167/2022/11/saahomescom-homepage-video-Moment.jpg"
      >
        <source src="https://assets.thesparksite.com/video/pay-it-forward-homes.com/Adam%20Shwartz%20Video%20Compressed.mp4" type="video/mp4" />
      </video>
      ...
      {/* Hero Content */}
      <div className="relative z-20 flex-1 flex items-center justify-center pt-32 pb-8 px-6">
