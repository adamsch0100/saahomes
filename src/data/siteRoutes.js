...
const staticPages = [
  ...
  },
  {
    ...
    priority: '0.95',
    changefreq: 'daily',
    title: 'Northern Colorado Homes for Sale | Fort Collins & Loveland',
    description: 'Search live Northern Colorado homes for sale in Fort Collins, Loveland, Windsor and Greeley. IRES MLS listings updated daily for Larimer and Weld counties.',
  ...
  },
  {
    ...
    priority: '0.95',
    changefreq: 'weekly',
    title: 'CHFA Schools To Home Program (2026): 25% Down Payment',
    description: 'CHFA Schools To Home gives Colorado public school employees up to 25% down payment assistance with no monthly payment. See 2026 eligibility and limits.',
  ...
  },
  {
    ...
    priority: '0.95',
    changefreq: 'weekly',
    title: 'Colorado Champions Home Loan | CHFA First Responder DPA',
    description: 'Colorado Champions Home Loan expands CHFA eligibility for police, firefighters, EMTs and 911 dispatchers. See 2026 terms and how to qualify in Northern Colorado.',
